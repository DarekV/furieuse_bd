...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const tlScrollBarMain = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            trigger: ".map-viewport",
            start: "top top",
            end: "+=20000",
    ...
    const tlScrollBar = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            trigger: ".map-viewport",
            start: "top top",
            end: "+=5000",
    ...
    const tlScrollBar2 = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    tlScrollBarMain.add(tlScrollBar).addLabel("animationsStart", "+=5000").add(tlScrollBar2);
    (0, _gsap.gsap).to(".map-ysa", {
        x: 520,
        ease: "none",
        scrollTrigger: {
    ...
    const baron = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            start: "animationsStart+=5000",
            end: "+=15000",
            scrub: true
    ...
    (0, _gsap.gsap).to(".map-first-button", {
        opacity: 1,
        ease: "none",
        scrollTrigger: {
    ...
    (0, _gsap.gsap).to(".map-second-button", {
        opacity: 1,
        ease: "none",
        scrollTrigger: {
    ...
    (0, _gsap.gsap).to(".map-third-button", {
        opacity: 1,
        ease: "none",
        scrollTrigger: {
